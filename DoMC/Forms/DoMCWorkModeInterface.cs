...
namespace DoMC
{
    public partial class DoMCWorkModeInterface : Form, IDoMCSettingsUpdatedProvider, IMainUserInterface
    {
        ...
        private void pnlCurrentSockets_Paint(object sender, PaintEventArgs e)
        {
            ...
            var bmp = VisualTools.DrawMatrix(pnlCurrentSockets.Size, goodsockets, socketsToSave, Context.WorkingState.ErrorsBySockets, IsSocketsChecking, Color.LawnGreen, Color.Red, Color.LightGray, Color.LimeGreen, pbCurrentShowStatistics.IsPressed);
