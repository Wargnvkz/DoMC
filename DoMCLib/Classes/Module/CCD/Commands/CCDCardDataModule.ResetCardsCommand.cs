...
namespace DoMCLib.Classes.Module.CCD
{
    ...
    {
        public class ResetCardsCommand : WaitingCommandBase
        {
            CCDCardDataCommandResponse result = new CCDCardDataCommandResponse();
            public ResetCardsCommand(IMainController mainController, AbstractModuleBase module) : base(mainController, module, typeof(DoMCApplicationContext), null) { }
